...
/*! \fn dbf_GetStringVersion(P_DBF *p_dbf)
...
/*! \fn uint32_t dbf_ColumnAddress(P_DBF *p_dbf, int column)
...
*/
uint32_t dbf_ColumnAddress(P_DBF *p_dbf, int column);

/*! \fn int dbf_GetDate(P_DBF *p_dbf, char *date)
...
*/
int dbf_GetDate(P_DBF *p_dbf, char *date);
