...
ifeq ($(TARGET), Linux)
	...
	( cd trpstr && make TARGET=$(TARGET) CC=$(CC) AR=$(AR) )
	( cd trpcss && make TARGET=$(TARGET) CC=$(CC) AR=$(AR) )
	( cd trpgcrypt && make TARGET=$(TARGET) CC=$(CC) AR=$(AR) )
	( cd trpminizip && make TARGET=$(TARGET) CC=$(CC) AR=$(AR) )
...
clean:
	...
	( cd trpstr && make clean )
	( cd trpcss && make clean )
	( cd trpgcrypt && make clean )
	( cd trpminizip && make clean )
