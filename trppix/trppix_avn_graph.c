...
static void trp_pix_avn_graph_calculate_max_avg_frame_size( trp_vid_t *vid );
static uns8b trp_pix_avn_graph_low( int tipo, trp_vid_t *vid, trp_obj_t *pix, trp_obj_t *framecnt,
...
{
    return trp_pix_avn_graph_low( 0, (trp_vid_t *)obj, pix, framecnt, UNDEF, UNDEF, UNDEF, UNDEF, UNDEF, UNDEF );
}

uns8b trp_pix_avn_graph_size( trp_obj_t *obj, trp_obj_t *pix, trp_obj_t *framecnt, trp_obj_t *mag, trp_obj_t *avg_int )
{
    return trp_pix_avn_graph_low( 1, (trp_vid_t *)obj, pix, framecnt, mag, avg_int, UNDEF, UNDEF, UNDEF, UNDEF );
}
...
{
    return trp_pix_avn_graph_low( 2, (trp_vid_t *)obj, pix, framecnt, UNDEF, UNDEF, vbv_size, vbv_init, vbv_rate, fps );
}
                                    ...
                                    trp_obj_t *v_size, trp_obj_t *v_init, trp_obj_t *v_rate, trp_obj_t *fps )
{
    ...
    if ( ( vid->tipo != TRP_VID ) ||
        ...
        return 1;
    if ( ( ( map = ((trp_pix_t *)pix)->map.p ) == NULL ) ||
         ( vid->fp == NULL ) )
        return 1;
    w = ((trp_pix_t *)pix)->w;
    h = ((trp_pix_t *)pix)->h;
    ...
    case 0:
        ...
        break;
    case 1:
        trp_pix_avn_graph_calculate_max_avg_frame_size( vid );
