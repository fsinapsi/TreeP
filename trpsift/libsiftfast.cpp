...
static int g_nComputeDescriptors=1;
...
static vector<float> _bufh; //TODO, make 16 byte aligned
static vector<float> _bufv; //TODO, make 16 byte aligned
...
#if defined(__SSE__) && !defined(SIMDMATH_H) // copied from libsimdmath
